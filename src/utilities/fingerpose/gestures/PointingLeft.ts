...
pointLeftDescription.addDirection(Finger.Index, FingerDirection.DiagonalUpLeft, 0.8);
...
for (let finger of [Finger.Middle, Finger.Ring, Finger.Pinky]) {
    ...
    pointLeftDescription.addDirection(finger, FingerDirection.DiagonalUpLeft, 0.8);
